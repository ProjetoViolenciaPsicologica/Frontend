      ...
      <div className="flex h-full w-full flex-col items-center pl-4 lg:items-start lg:pl-12">
        ...
        <div className="mt-8 pl-6">
          ...
          >
            <li>
              {" "}
              O protótipo é dividido em análise de Medo, Dependência Emocional e
              Controle Absoluto.
            </li>
            <li>
              Estas dimensões são divididas em valores para formar uma análise.
            </li>
            <li>
              Na suspeita de vítima de violência, dirija-se a pessoa com a
              seguinte informação:
            </li>
          </ul>
        </div>
        ...
        <div className="mt-8 w-[90%]">
          ...
          >
            {" "}
            “Farei agora algumas perguntas sobre a conduta de pessoas próximas a
            você (sr., sra.). Por favor, responda com nunca; ou, às vezes; ou,
            frequentemente; ou, sempre, de acordo com o que lhe acontece no
            convívio com a pessoa de quem você (sr., sra.) se lembrar.”
          </span>
        </div>
        ...
        <div className="mt-8 pl-6">
          ...
          >
            <li>
              {`O instrumento foi elaborado com 15 questões que remetem à
              ocorrência da violência psicológica e permitem a pontuação 1 para
              "Nunca", 2 para "Às vezes", 3 para "Frequentemente" e 4 para
              "Sempre". `}
            </li>
            <li>
